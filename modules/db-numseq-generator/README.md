...
**Category:** `ops` · **Status:** stable

Generate sequential document/invoice numbers with prefix, period (YYYYMM), and auto-increment. Useful for invoices, orders, leads.

## Use it

The implementation is a single self-contained file: [`src/gen_no.php`]("src/gen_no.php").
